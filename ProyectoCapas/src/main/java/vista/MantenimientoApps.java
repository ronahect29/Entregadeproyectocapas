 ...
 * @author visitante
 */
public class MantenimientoApps extends javax.swing.JInternalFrame {

    public void llenadoDeCombos() {
        AppDAO empleadoDAO = new AppDAO();
        List<Vendedor> empleados = empleadoDAO.select();
        cbox_empleado.addItem("Seleccione una opción");
        for (int i = 0; i < empleados.size(); i++) {
            cbox_empleado.addItem(empleados.get(i).getNombreVendedor());
        }
    }

    public void llenadoDeTablas() {
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.addColumn("ID App");
        modelo.addColumn("nombre App");
        modelo.addColumn("estadoa App");
        AppDAO appDAO = new AppDAO();
        List<Vendedor> vendedores = appDAO.select();
